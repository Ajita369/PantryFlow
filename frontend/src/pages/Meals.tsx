		...
		<section className="page">
			...
			<section className="card">
				...
				{!loading && data?.urgent_items.length === 0 ? (
					<EmptyState
						title="No urgent pantry items"
						message="Add pantry items to see urgency alerts and meal suggestions."
					/>
				) : null}
			</section>
				...
				<div className="meals-grid">
					{loading ? (
						...
						<EmptyState
							...
							message="Generate meals or add more pantry items to see quick picks."
						/>
					)}
				</div>
			</section>
			...
			<section className="card">
				...
				<div className="meals-grid">
					{loading ? (
						...
						<EmptyState
							title="No weekly matches"
							message="Generate meals to get week-long meal options."
						/>
					)}
				</div>
			</section>
				...
				<div className="meals-grid">
					{loading ? (
						...
						<EmptyState
							...
							message="Add pantry items or generate meals to fill this list."
						/>
					)}
				</div>
			</section>
